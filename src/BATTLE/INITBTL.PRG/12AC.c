...
static int (*D_800FAF7C[])(u_char*, short) = { _invalidOpcode, _invalidOpcode,
    ...
    vs_battle_script_actorSfxPanVolumeControl, func_800B784C, func_800B792C, func_800B7A98, func_800B7B58,
    ...
    vs_battle_script_jumpFwdIfFlagContext, func_800B66E4, vs_battle_script_setJumpBackCounter,
    vs_battle_script_jumpBackIfCounter, vs_battle_script_jumpFwd4, vs_battle_script_jumpFwd3,
    ...
    func_800B9F90, func_800B9FC0, vs_battle_script_enableRoomMechanismUpdates, vs_battle_script_roomMechanismControl, vs_battle_script_setRoomAmbientSoundSuspended,
    ...
    func_800B66E4, vs_battle_script_loadSoundFileById, vs_battle_script_processSoundQueue,
    ...
    func_800BB33C, func_800BB35C, func_800B66EC, vs_battle_script_setScreenEffectEnabled, vs_battle_script_setupAngleTween,
    vs_battle_script_setupAngleTween, func_800BD6C4, func_800BD6C4, func_800BD6C4, func_800BD6C4,
